...
const AudioSpinner = (props) => {
    ...
    return (<svg viewBox="0 0 55 80" xmlns="http://www.w3.org/2000/svg" fill="currentColor" data-test-name="audio" role="img" {...mergedProps} width={mergedProps.width || 55} height={mergedProps.height || 80} class={mergedProps.class || ''}>

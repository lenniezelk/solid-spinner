...
const Hearts = (props) => {
    ...
    return (<svg viewBox="0 0 140 64" xmlns="http://www.w3.org/2000/svg" fill="currentColor" data-test-name="hearts" role="img" {...mergedProps} width={mergedProps.width || 140} height={mergedProps.height || 64} class={mergedProps.class || ''}>
